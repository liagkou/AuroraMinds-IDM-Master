...
public class CombinedOIDCIdP extends PabcIdPImpl implements PestoIdP {

    public CombinedOIDCIdP(PestoDatabase database, List<IdentityProver> identityProvers, Map<String, MFAAuthenticator> authenticators, ServerCryptoModule cryptoModule, String issuerId, int rateLimit) throws SetupException {
